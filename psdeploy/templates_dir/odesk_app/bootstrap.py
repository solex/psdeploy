...
def get_pre_reqs(pre_req_txt):
    ...
    try:
        ...
        _warn("Couldn't find pre-reqs file: %s, use default pre-reqs")
...
def pass_control_to_fabric(ve_target):
    """Passing further control to fabric"""
    try:
        import fabfile
    except ImportError:
        pass
...
def bootstrap(pre_req_txt, ve_target, no_site=True, upgrade=False):
    ...
    do(pass_control_to_fabric, ve_target)
